...
- Current Learning: Expanding my software engineering practices, specifically focusing on clean, modular Python code and algorithmic problem solving applied to genomic data.
...
## Technologies & Tools
- Languages: Python, R
- Concepts: Sequence analysis, algorithm design, batch data processing, version control (Git).
